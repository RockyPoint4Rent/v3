...
const FALLBACK_IMAGES = [
  ...
  'https://images.pexels.com/photos/2598638/pexels-photo-2598638.jpeg?auto=compress&cs=tinysrgb&w=900',
...
const amenities = [
  ...
  { icon: Waves, label: 'Private Pool & Waterfall' },
...
export default function CasaDelphinePage({ onBack, onBook }: Props) {
  const meta = PROPERTIES['casa-delphine'];
  useSeo({
    title: meta.title,
    description: meta.description,
    canonical: '/casa-delphine',
  ...
  useEffect(() => {
    const url = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/cloudinary-images?folder=casa-delphine`;
  ...
  return (
    <div className="min-h-screen bg-sand-50">
      ...
      <div className="relative h-[55vh] md:h-[65vh] overflow-hidden">
        <img
          src={images[0]}
          alt="Casa Delphine vacation rental in Puerto Peñasco, Mexico — 6 bedrooms, private pool with waterfall"
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 md:px-10 pb-8 md:pb-12">
          ...
          <h1 className="font-serif text-4xl md:text-6xl font-light text-white mb-2 tracking-wide">
            Casa Delphine Rocky Point Vacation Rental
          </h1>
          <p className="font-sans text-white/80 text-base md:text-lg font-light">
            6-Bedroom Vacation Home in Puerto Peñasco · Private Pool with Waterfall · Sleeps 25
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4">
          <div className="flex flex-wrap items-center gap-6 md:gap-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-sans text-sm">6 Bedrooms · 12 Beds</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-sans text-sm">Pool & Waterfall</span>
            </div>
            <div className="ml-auto hidden md:block">
              <button
                onClick={() => onBook('Casa Delphine', 25)}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {images.slice(0, 5).map((src, i) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Casa Delphine Rocky Point rental photo ${i + 1}`}
                      loading="lazy"
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed font-light mb-4">
                    My house — your house — is quiet, cozy, and relaxing, with everything you need for a perfect stay. Enjoy king-size beds, big-screen TVs, high-speed internet, Xbox, and a fully equipped kitchen. Outside, you'll find a BBQ grill, sink, dishes, a fire pit, and even a romantic couples' swing right next to your brand-new private pool.
                  </p>
                  <p className="font-sans text-slate-500 leading-relaxed font-light italic text-sm mb-6">
                    Mi casa — tu casa — es tranquila, acogedora y relajante, con todo lo que necesitas para una estancia perfecta. Disfruta camas king, pantallas grandes, internet de alta velocidad, Xbox y una cocina completamente equipada.
                  </p>
                  <video
                    src="https://res.cloudinary.com/duebfnnel/video/upload/v1779155134/delphino_oootk6.mp4"
                    autoPlay
                    loop
                    playsInline
                    preload="auto"
                ...
                <div className="bg-white p-7 shadow-sm border border-slate-100">
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed font-light">
                    The house offers a very relaxing and quiet environment, with open space to celebrate your getaway. We are just 5 minutes from the beach, restaurants, and the Malecón, perfect for enjoying the nightlife. You can also unwind in your own private, romantic swimming pool with a beautiful waterfall.
                  </p>
                </div>
                ...
                <div className="bg-ocean-50 p-7 border-l-4 border-teal-light">
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed font-light">
                    My house is your house. It is always fully disinfected before and after every stay. We are only 5 minutes from the beach and just seconds away from anything you may need. The home is thoroughly cleaned, sanitized, and COVID-compliant, so you can feel safe and comfortable throughout your stay.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-start gap-3 bg-white p-5 shadow-sm border border-slate-100">
                    ...
                    <div>
                      ...
                      <p className="font-sans text-slate-500 text-sm font-light">5 minutes from the beach, the Malecón, restaurants, and local nightlife. Close to everything you need.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {[
                    ...
                    'BBQ grill & outdoor sink',
                    'Free parking',
                    'King-size beds',
                    'Big-screen TVs',
                    'Xbox gaming console',
                    'Fire pit',
                    'Romantic couples swing',
                    'Outdoor dining area',
                  ].map((item) => (
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-5">
              ...
              <div className="bg-white shadow-sm border border-slate-100 p-5">
                ...
                <div className="space-y-2">
                  {[
                    { name: 'Airbnb', url: 'https://www.airbnb.com/rooms/38053103?unique_share_id=eb666952-ec98-470b-96a2-b44fc8040db1&viralityEntryPoint=1&s=76' },
                    { name: 'Booking.com', url: 'https://www.booking.com/hotel/mx/rocky-point-delphine-home-cozy-pool-affordable-puerto-penasco.html' },
                    { name: 'VRBO', url: 'https://www.vrbo.com/3910460' },
                  ].map(({ name, url }) => (
      ...
      <BestForSection propertyName="Casa Delphine" />
      <BookingCtaSection propertyName="Casa Delphine" maxGuests={25} onBook={onBook} />
      <PropertyFaqSection slug="casa-delphine" />
      <InternalLinksSection currentSlug="casa-delphine" />
      <Footer />

      <StickyMobileCta
        label="Book Casa Delphine"
        onClick={() => onBook('Casa Delphine', 25)}
      />
      ...
      <PropertyStructuredData
        data={{
          name: 'Casa Delphine',
          description: '6-bedroom vacation rental in Puerto Peñasco, Mexico with private pool and waterfall. Sleeps up to 25 guests. Book direct with Rocky Point 4 Rent.',
          url: `${SITE_CONFIG.domain}/casa-delphine`,
          image: FALLBACK_IMAGES[0],
          bedrooms: 6,
          bathrooms: 4,
          maxGuests: 25,
          slug: 'casa-delphine',
          amenities: ['Air Conditioning', 'High-Speed WiFi', 'Full Kitchen', 'Free Parking', 'Private Pool with Waterfall', 'BBQ Grill', 'Xbox Gaming Console', 'Fire Pit'],
        }}
      />
      <PropertyBreadcrumbSchema slug="casa-delphine" name="Casa Delphine" />
      {lightboxIndex !== null && (
        <div
        ...
        >
          ...
          <img
            ...
            alt={`Casa Delphine Rocky Point rental photo ${lightboxIndex + 1}`}
